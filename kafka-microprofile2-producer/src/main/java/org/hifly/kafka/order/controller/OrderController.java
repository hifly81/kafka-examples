...
public class OrderController {
    ...
    public RecordMetadata create(Order order) {
        ...
        JsonProducer<OrderEvent> jsonProducer = new JsonProducer<>("org.hifly.kafka.order.producer.OrderEventJsonSerializer");
        jsonProducer.start();
