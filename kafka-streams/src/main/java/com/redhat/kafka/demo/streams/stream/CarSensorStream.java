...
public class CarSensorStream {
    ...
    public void stream(
        ...
        final Serializer<SpeedInfo> speedInfoJsonSerializer = new SpeedInfoSerializer();
        final Deserializer<SpeedInfo> speedInfoDeserializer = new SpeedInfoDeserializer();
        final Serde<SpeedInfo> speedInfoSerde = Serdes.serdeFrom(speedInfoJsonSerializer, speedInfoDeserializer);

        StreamsBuilder builder = new StreamsBuilder();

        ObjectMapper mapper = new ObjectMapper();

        //create a kstream from car sensor data but extract only the speed
