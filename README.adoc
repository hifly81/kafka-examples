...
It uses a _io.confluent.kafka.serializers.KafkaAvroSerializer_ for value and a GenericRecord.
...
It uses a _io.apicurio.registry.utils.serde.AvroKafkaSerializer_ for value and a GenericRecord.
