...
Examples have been tested with a Linux machine and Java SE 11 and 17 .
...
List of programs required to run the examples:
 ...
 - _Apache Maven_
 - _python pip_ (only for python examples)
...
Images are downloaded from Docker Hub _confluentinc_ and are based on _Confluent 7.4.0 Community_ licensed (Apache Kafka® version 3.4.0):
...
To launch the examples run components on port 9092:
