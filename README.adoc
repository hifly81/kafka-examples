...
It uses link:https://kafka.apache.org/36/javadoc/org/apache/kafka/common/serialization/StringSerializer.html[org.apache.kafka.common.serialization.StringSerializer] for key serialization and a _org.hifly.kafka.demo.producer.serializer.json.JsonSerializer_ for value serialization.
...
This example shows how to define a SASL Plain with SSL listener on listener port 9092.
