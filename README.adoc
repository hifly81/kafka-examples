...
=== Kafka unixcommand Source Connector
...
Implementation of a session window (5 minutes of inactive). Vehicle positions (latitude and logitude) are collected and a new window opens when the vehicle does not send its position for 5 minutes. This is considered as a new "trip".
