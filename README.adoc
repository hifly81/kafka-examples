...
Default docker images are downloaded from Docker Hub _confluentinc_ and are based on _Confluent 7.4.0 Community_ licensed (Apache Kafka® version 3.4.0):
...
In this example, kafka messages will be produced to a topic named _items_ with a reference for the object stored in _MinIO_.
