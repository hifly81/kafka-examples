...
=== CDC with Debezium MongoDB Source Connector
...
Script will also insert a document into _inventory_ database and _customer_ collection:
...
Run a consumer on _test.inventory.customers_ topic and see the records:

[source,bash]
----
kafka-avro-console-consumer --bootstrap-server localhost:9092 --topic test.inventory.customers --from-beginning --property schema.registry.url=http://localhost:8081
----

[source,bash]
----
{"before":null,"after":{"string":"{\"_id\": 1006,\"first_name\": \"Bob\",\"last_name\": \"Hopper\",\"email\": \"thebob@example.com\"}"},"updateDescription":null,"source":{"version":"2.4.2.Final","connector":"mongodb","name":"test","ts_ms":0,"snapshot":{"string":"last"},"db":"inventory","sequence":null,"rs":"rs0","collection":"customers","ord":-1,"lsid":null,"txnNumber":null,"wallTime":null},"op":{"string":"r"},"ts_ms":{"long":1730741797590},"transaction":null}
----
