...
Official documentation on how to install Docker on your environment:
...
If you will need to change the docker image version for the specific components, just update file _.env_ in root directory.
