...
[source,bash]
----
docker run confluentinc/cp-kafkacat echo '{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P -b localhost:9092 -t input-topic -P
docker run confluentinc/cp-kafkacat echo '{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P-b localhost:9092 -t input-topic -P -H ERROR=xxxxx
docker run confluentinc/cp-kafkacat echo '{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P-b localhost:9092 -t input-topic -P -H ERROR=xxxxx
docker run confluentinc/cp-kafkacat echo '{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P -b localhost:9092 -t input-topic -P -H ERROR=xxxxx
docker run confluentinc/cp-kafkacat echo '{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P -b localhost:9092 -t input-topic -P -H ERROR=xxxxx
----
