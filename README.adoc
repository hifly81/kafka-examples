...
Folder: link:cdc-debezium-mongo/[cdc-debezium-mongo-smt]

Usage of link:https://debezium.io/documentation/reference/stable/connectors/mongodb.html[Debezium Source Connector for MongoDB] to send updates into a topic. This example will use out ob the SMTs to transform the original record.
