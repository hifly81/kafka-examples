...
Images are downloaded from _confluentinc_ and are based on _Confluent 7.2.2_ Community licensed (kafka version 3.2.0):

* Zookeeper: confluentinc/cp-zookeeper:7.2.2
* Kafka: confluentinc/cp-kafka:7.2.2
* Schema Registry: confluentinc/cp-schema-registry:7.2.2
* Connect: custom image based on confluentinc/cp-kafka-connect-base:7.2.2
...
[source,bash]
----
docker-compose -f kafka-distributed-tracing/docker-compose-tracing.yml down
----
