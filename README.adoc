...
Device Maintenance are ingested into a kafka topic _device_maintenance_ with a JDBC Source Connector.
...
Execute the ksqlDB statements: TABLE _DEVICE_MAINTENANCE_ RIGHT JOIN TABLE _DEVICE_
