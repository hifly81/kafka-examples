...
Images are downloaded from _confluentinc_ and are based on _Confluent 7.3.0 Community_ licensed (kafka version 3.3.0):
...
. _kafka-topics - create, delete, describe, or change a topic
