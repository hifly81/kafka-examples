...
=== Window Tumbling example: heart rate monitoring

Implementation of a window tumbling (1 minute) to monitor heart rate. Values over a threshold of 120 beats per minute are reported.
