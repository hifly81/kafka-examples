...
Sink will generate a new entry every 100 messages (_flush_size_).

To generate random record for topic _gaming-player-activity_ we will use link:https://github.com/ugol/jr[jr] tool

Send 1000 messages to _gaming-player-activity_ topic:
...
image::images/minio.png[Outbox table]
