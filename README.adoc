...
Default docker images are downloaded from Docker Hub _confluentinc_ and are based on _Confluent 7.5.1 Community_ licensed (Apache Kafka® version 3.5.1):
...
Execute on Linux (amd64):

[source,bash]
----
docker run confluentinc/cp-kafkacat echo 'alice,{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P -K ,
docker run confluentinc/cp-kafkacat echo 'alice,{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P -H ERROR=xxxxx -K ,
docker run confluentinc/cp-kafkacat echo 'alice,{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P -H ERROR=xxxxx -K ,
docker run confluentinc/cp-kafkacat echo 'alice,{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P -H ERROR=xxxxx -K ,
docker run confluentinc/cp-kafkacat echo 'alice,{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P -H ERROR=xxxxx -K ,
----

Execute on Mac (arm64):

[source,bash]
----
docker run confluentinc/cp-kafkacat:7.1.9.arm64 echo 'alice,{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P -K ,
docker run confluentinc/cp-kafkacat:7.1.9.arm64 echo 'alice,{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P -H ERROR=xxxxx -K ,
docker run confluentinc/cp-kafkacat:7.1.9.arm64 echo 'alice,{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P -H ERROR=xxxxx -K ,
docker run confluentinc/cp-kafkacat:7.1.9.arm64 echo 'alice,{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P -H ERROR=xxxxx -K ,
docker run confluentinc/cp-kafkacat:7.1.9.arm64 echo 'alice,{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P -H ERROR=xxxxx -K ,
----
