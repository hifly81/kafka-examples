...
:revdate: August 04, 2023
:revnumber: 1.1.17.Final
:version-label!:
:toc: left
:toclevels: 3
...
Class _org.hifly.kafka.demo.streams.queries.QueryController_ shows how to execute queries against the local store. Controller is attached at the moment at the following streams example:

 - StreamCounter

When running the _StreamCounter_ example, you will find in the terminal entries like:
