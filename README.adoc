...
Images are downloaded from _confluentinc_ and are based on _Confluent 7.1.1_ version (kafka version 3.1):

* Zookeeper: confluentinc/cp-zookeeper:7.1.1
* Kafka: confluentinc/cp-kafka:7.1.1
* Schema Registry: confluentinc/cp-schema-registry:7.1.1
* Connect: custom image based on confluentinc/cp-kafka-connect-base:7.1.1
* ksqlDB server: confluentinc/ksqldb-server:0.23.1
* ksqlDB cli: confluentinc/ksqldb-cli:0.23.1
