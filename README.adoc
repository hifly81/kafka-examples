...
implemented using AspectJ framework. The _@Aspect_, implemented in class _org.hifly.kafka.smt.aspectj.SMTAspect_ logs the input arg (_SinkRecord_ object) to the standard output.
