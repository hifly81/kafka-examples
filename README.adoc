= Apache Kafka® examples: Practical examples with Apache Kafka®
:author: Giovanni Marigi
:email: gio.marigi@gmail.com
:revdate: September 26, 2023
:revnumber: 1.2.0.Final
:version-label!:
:toc: left
:toclevels: 3
...
This solution could be implemented on consumer side to handle errors in processing records without blocking the input topic.
 ...
 . Consumer processes records and commit the offset
 . if a record can't be processed (simple condition here is the existence of a specific HEADER), it is sent to a retry topic, if the number of retries is not yet exhausted
...
[source,bash]
----
echo '{"col_foo":1}'|kcat -b localhost:9092 -t input-topic -P
echo '{"col_foo":2}'|kcat -b localhost:9092 -t input-topic -P -H ERROR=xxxxx
echo '{"col_foo":3}'|kcat -b localhost:9092 -t input-topic -P -H ERROR=xxxxx
echo '{"col_foo":4}'|kcat -b localhost:9092 -t input-topic -P -H ERROR=xxxxx
echo '{"col_foo":5}'|kcat -b localhost:9092 -t input-topic -P -H ERROR=xxxxx
----
...
[source,bash]
----
Group id 43d50afb-2631-4098-8d09-6cfa0964e3bd - Consumer id: consumer-43d50afb-2631-4098-8d09-6cfa0964e3bd-1-c53cb4d5-110c-4533-a9f5-01d7908b6e35 - Topic: input-topic - Partition: 0 - Offset: 3 - Key: null - Value: {"col_foo":1}
Group id 43d50afb-2631-4098-8d09-6cfa0964e3bd - Consumer id: consumer-43d50afb-2631-4098-8d09-6cfa0964e3bd-1-c53cb4d5-110c-4533-a9f5-01d7908b6e35 - Topic: input-topic - Partition: 0 - Offset: 4 - Key: null - Value: {"col_foo":2}
Error message detected: number of retries left 2
send to RETRY topic: retry_topic
Group id 43d50afb-2631-4098-8d09-6cfa0964e3bd - Consumer id: consumer-43d50afb-2631-4098-8d09-6cfa0964e3bd-1-c53cb4d5-110c-4533-a9f5-01d7908b6e35 - Topic: input-topic - Partition: 0 - Offset: 5 - Key: null - Value: {"col_foo":3}
Error message detected: number of retries left 1
send to RETRY topic: retry_topic
Group id 43d50afb-2631-4098-8d09-6cfa0964e3bd - Consumer id: consumer-43d50afb-2631-4098-8d09-6cfa0964e3bd-1-c53cb4d5-110c-4533-a9f5-01d7908b6e35 - Topic: input-topic - Partition: 0 - Offset: 6 - Key: null - Value: {"col_foo":4}
Error message detected: number of retries left 0
number of retries exhausted, send to DLQ topic: dlq_topic
----
