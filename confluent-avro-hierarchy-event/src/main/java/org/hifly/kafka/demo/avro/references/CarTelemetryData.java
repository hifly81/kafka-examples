...
public class CarTelemetryData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public CarTelemetryData(java.lang.Double speed, java.lang.CharSequence latitude, java.lang.CharSequence longitude, org.hifly.kafka.demo.avro.references.CarInfo info) {
    this.speed = speed;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: info = (org.hifly.kafka.demo.avro.references.CarInfo)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public org.hifly.kafka.demo.avro.references.CarInfo getInfo() {
    return info;
  }
   ...
   * @param value the value to set.
   */
  public void setInfo(org.hifly.kafka.demo.avro.references.CarInfo value) {
    this.info = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CarTelemetryData>
    ...
    private java.lang.CharSequence longitude;
    private org.hifly.kafka.demo.avro.references.CarInfo info;
    private org.hifly.kafka.demo.avro.references.CarInfo.Builder infoBuilder;
    ...
    private Builder(org.hifly.kafka.demo.avro.references.CarTelemetryData.Builder other) {
      ...
      if (other.hasInfoBuilder()) {
        this.infoBuilder = org.hifly.kafka.demo.avro.references.CarInfo.newBuilder(other.getInfoBuilder());
      }
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public org.hifly.kafka.demo.avro.references.CarTelemetryData.Builder setInfo(org.hifly.kafka.demo.avro.references.CarInfo value) {
     ...
     * @return This builder.
     */
    public org.hifly.kafka.demo.avro.references.CarInfo.Builder getInfoBuilder() {
      if (infoBuilder == null) {
        if (hasInfo()) {
          setInfoBuilder(org.hifly.kafka.demo.avro.references.CarInfo.newBuilder(info));
        } else {
          setInfoBuilder(org.hifly.kafka.demo.avro.references.CarInfo.newBuilder());
        }
      }
      return infoBuilder;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public org.hifly.kafka.demo.avro.references.CarTelemetryData.Builder clearInfo() {
      info = null;
      infoBuilder = null;
    ...
    public CarTelemetryData build() {
      try {
        ...
        if (infoBuilder != null) {
          ...
          record.info = fieldSetFlags()[3] ? this.info : (org.hifly.kafka.demo.avro.references.CarInfo) defaultValue(fields()[3]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.info == null) {
        this.info = new org.hifly.kafka.demo.avro.references.CarInfo();
      }
