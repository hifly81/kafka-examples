...
public class RunnerProducer {
    ...
    public static void main(String[] args) {
        ...
        carTelemetryData.setInfo(carInfo);

        try (KafkaProducer<String, CarTelemetryData> producer = new KafkaProducer<>(loadProducerConfig())) {
            ProducerRecord<String, CarTelemetryData> producerRecord = new ProducerRecord<>(TOPIC, "car1", carTelemetryData);
